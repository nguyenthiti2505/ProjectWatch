...
<header>
  <nav class="navbar navbar-fixed-top navbar-expand-md" style="background: black;" >
     ...
     <h4 class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01"     
          aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">Menu
